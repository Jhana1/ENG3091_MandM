...
static uint8 XDATA OV9650_1_I2C_slReadBuf[OV9650_1_I2C_BTLDR_SIZEOF_READ_BUFFER];

/* I2C read buffer - The host reads responses from it */
static uint8 XDATA OV9650_1_I2C_slWriteBuf[OV9650_1_I2C_BTLDR_SIZEOF_WRITE_BUFFER];


/*******************************************************************************
* Function Name: OV9650_1_I2C_CyBtldrCommStart
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  OV9650_1_I2C_slWriteBuf - The global variable used to store a received
*                                command.
*  OV9650_1_I2C_slReadBuf -  The global variable used to store a response.
...
void OV9650_1_I2C_CyBtldrCommStart(void) CYSMALL 
{
    ...
    OV9650_1_I2C_SlaveInitWriteBuf(OV9650_1_I2C_slWriteBuf, OV9650_1_I2C_BTLDR_SIZEOF_WRITE_BUFFER);
    OV9650_1_I2C_SlaveInitReadBuf (OV9650_1_I2C_slReadBuf, 0u);
...
/*******************************************************************************
* Function Name: OV9650_1_I2C_CyBtldrCommStop
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: OV9650_1_I2C_CyBtldrCommReset
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: OV9650_1_I2C_CyBtldrCommWrite
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
cystatus OV9650_1_I2C_CyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut) CYSMALL
    ...
    if((NULL != pData) && (size > 0u))
    {
        ...
        *count = size;  /* Buffer was copied to I2C buffer */
        ...
        while(0u != timeoutMs)  /* Wait till response is read */
        {
            ...
            CyDelay(OV9650_1_I2C_WAIT_1_MS);
            timeoutMs--;
        }
    }
...
/*******************************************************************************
* Function Name: OV9650_1_I2C_CyBtldrCommRead
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  OV9650_1_I2C_slWriteBuf - The global variable used to store a
*                                received command.
*
*******************************************************************************/
         ...
         
{
    ...
    if((NULL != pData) && (size > 0u))
    {
        ...
        while(0u != timeoutMs)  /* Wait for command from host */
        {
            ...
            if(0u != (OV9650_1_I2C_slStatus & OV9650_1_I2C_SSTAT_WR_CMPLT))
            {
                /* Define how many bytes host has been written */
                byteCount = OV9650_1_I2C_slWrBufIndex;
                *count = (uint16) byteCount;

                /* Copy command to pData buffer */
                (void) memcpy((void *) pData, (void *) OV9650_1_I2C_slWriteBuf,
                              OV9650_1_I2C_MIN_UNT16(byteCount, size));
