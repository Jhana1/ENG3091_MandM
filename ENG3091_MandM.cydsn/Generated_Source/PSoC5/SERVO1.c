...
{
    uint8 staticBits = (SERVO1_DR & (uint8)(~SERVO1_MASK));
    SERVO1_DR = staticBits | ((uint8)(value << SERVO1_SHIFT) & SERVO1_MASK);
}
...
*
*  SERVO1_DM_STRONG     Strong Drive 
*  SERVO1_DM_OD_HI      Open Drain, Drives High 
*  SERVO1_DM_OD_LO      Open Drain, Drives Low 
*  SERVO1_DM_RES_UP     Resistive Pull Up 
*  SERVO1_DM_RES_DWN    Resistive Pull Down 
*  SERVO1_DM_RES_UPDWN  Resistive Pull Up/Down 
*  SERVO1_DM_DIG_HIZ    High Impedance Digital 
*  SERVO1_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
