...
#define MOTOR1_UsingFixedFunction             (1u)
#define MOTOR1_DeadBandMode                   (0u)
#define MOTOR1_KillModeMinTime                (0u)
#define MOTOR1_KillMode                       (1u)
#define MOTOR1_PWMMode                        (0u)
#define MOTOR1_PWMModeIsCenterAligned         (0u)
#define MOTOR1_DeadBandUsed                   (0u)
...
#define MOTOR1_INIT_COMPARE_VALUE1        (127u)
...
#define MOTOR1_INIT_DEAD_TIME             (1u)
