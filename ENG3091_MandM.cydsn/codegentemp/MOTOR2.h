...
#define MOTOR2_UsingFixedFunction             (1u)
#define MOTOR2_DeadBandMode                   (0u)
#define MOTOR2_KillModeMinTime                (0u)
#define MOTOR2_KillMode                       (1u)
#define MOTOR2_PWMMode                        (0u)
#define MOTOR2_PWMModeIsCenterAligned         (0u)
#define MOTOR2_DeadBandUsed                   (0u)
...
#define MOTOR2_INIT_COMPARE_VALUE1        (127u)
...
#define MOTOR2_INIT_DEAD_TIME             (1u)
