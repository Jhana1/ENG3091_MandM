...
# Date: Sat, 05 Sep 2015 06:26:33 GMT
#set_units -time ns
...
create_generated_clock -name {MLClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 601 1201} [list [get_pins {ClockBlock/dclk_glb_3}]]
create_clock -name {MLClock(fixed-function)} -period 25000 -waveform {0 41.6666666666667} [get_pins {ClockBlock/dclk_glb_ff_3}]
create_generated_clock -name {MRClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 601 1201} [list [get_pins {ClockBlock/dclk_glb_4}]]
create_clock -name {MRClock(fixed-function)} -period 25000 -waveform {0 41.6666666666667} [get_pins {ClockBlock/dclk_glb_ff_4}]
...
# Project: C:\Users\xavieran\Desktop\ECE3091\PSOCProjects\ENG3091_MandM\ENG3091_MandM.cydsn\ENG3091_MandM.cyprj
# Date: Sat, 05 Sep 2015 06:26:26 GMT
