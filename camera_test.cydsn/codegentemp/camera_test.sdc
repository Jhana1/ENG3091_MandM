...
# Date: Tue, 20 Oct 2015 02:51:02 GMT
#set_units -time ns
...
create_clock -name {BEAM_Clock(routed)} -period 26318.18181818182 -waveform {0 13159.0909090909} [list [get_pins {ClockBlock/dclk_5}]]
create_clock -name {timer_clock(routed)} -period 100000 -waveform {0 50000} [list [get_pins {ClockBlock/dclk_6}]]
...
create_generated_clock -name {BEAM_Clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 1737 3475} [list [get_pins {ClockBlock/dclk_glb_5}]]
create_generated_clock -name {timer_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 6601 13201} -nominal_period 100000 [list [get_pins {ClockBlock/dclk_glb_6}]]
